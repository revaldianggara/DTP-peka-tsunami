angular.module("mapService_verif", [])
    ...
    .directive('ngMap', ['mapService_verif', '$http', function (mapService_verif, $http) {
        return {
            restrict: 'A',
            replace: true,
            link: function ($scope) {
                ...
                map_verif.on("click", function (e) {
                    ...
                    map_verif.forEachFeatureAtPixel(e.pixel, function (feature, layer) {
                        ...
                        if (lyrty == 'predTsu' || lyrty == 'EQ') {
                            $http({
                                ...
                                angular.copy(temp, mapService_verif.info_detail);
                                console.log(mapService_verif.info_detail.data);
                            ...
                            if (dlvl == 'warn' || dlvl == 'normal') {
                                $http({
                                    ...
                                    mapService_verif.sensorDetail(feature, lyrnm, response.data);
                                }, function queryError(response) {
                                    console.log('connection failed');
                                });
                                wclk = 1;
                    ...
                    if (wclk == 0) {
                        ...
                        mapService_verif.sensorDetail(undefined, undefined);
                        mapService_verif.hs_clicked = undefined;
                        mapService_verif.sens_clicked = undefined;
                        mapService_verif.type_clicked = undefined;
                        mapService_verif.senstype_clicked = undefined;
                    }
                });
