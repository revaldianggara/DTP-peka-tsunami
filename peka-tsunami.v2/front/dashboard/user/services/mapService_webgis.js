    ...
    .directive('ngMap', ['mapService_webgis', '$http', function (mapService_webgis, $http) {
        return {
            ...
            link: function ($scope) {
                ...
                map_webgis.on("click", function (e) {
                    var wclk = 0;
                    map_webgis.forEachFeatureAtPixel(e.pixel, function (feature, layer) {
                        const lyrnm = layer.get('name');
                        ...
                        if (lyrty == 'predTsu' || lyrty == 'EQ') {
                            $http({
                                ...
                                angular.copy(temp, mapService_webgis.info_detail);
                                console.log(mapService_webgis.info_detail.data);
                            ...
                            if (dlvl == 'warn' || dlvl == 'normal') {
                                $http({
                                    ...
                                    mapService_webgis.sensorDetail(feature, lyrnm, response.data);
                                }, function queryError(response) {
                                    console.log('connection failed');
                                });
                                wclk = 1;
                    ...
                    if (wclk == 0) {
                        ...
                        mapService_webgis.sensorDetail(undefined, undefined);
                        mapService_webgis.hs_clicked = undefined;
                        mapService_webgis.sens_clicked = undefined;
                        mapService_webgis.type_clicked = undefined;
                        mapService_webgis.senstype_clicked = undefined;
                    }
                });
                $('#map_webgis').data('map_webgis', map_webgis);
                mapService_webgis.mapInit(map_webgis, view);
            }
        };
    }]);