                ...
                hssource.forEachFeature(function (feature) {
                    ...
                    const rpointStyle = new ol.style.Style({
                        image: new ol.style.Icon({
                            ...
                            scale: 0.05,
                            src: 'assets/images/webgis/' + ity + aity + '.png'
                        })
                    });
            ...
            if (feature !== undefined) {
                ...
                const redpinStyle = new ol.style.Style({
                    image: new ol.style.Icon({
                        ...
                        anchorYUnits: 'fraction',
                        scale: 0.17,
                        src: 'assets/images/webgis/pin-blue.png'
                    })
                });
                feature.setStyle(redpinStyle);
                viewObj.animate({
    ...
    .directive('ngMap', ['mapService_dashboard', '$http', function (mapService_dashboard, $http) {
        return {
            ...
            link: function ($scope) {
                ...
                var map_dashboard = new ol.Map({
                    target: 'map_dashboard',
                ...
                map_dashboard.on("click", function (e) {
                    var wclk = 0;
                    map_dashboard.forEachFeatureAtPixel(e.pixel, function (feature, layer) {
                        const lyrnm = layer.get('name');
                        ...
                        if (lyrty == 'predTsu' || lyrty == 'EQ') {
                            $http({
                                ...
                                angular.copy(temp, mapService_dashboard.info_detail);
                                console.log(mapService_dashboard.info_detail.data);
                            ...
                            if (dlvl == 'warn' || dlvl == 'normal') {
                                $http({
                                    ...
                                    params: {
                                        locid: feature.id_,
                                        timid: ltime,
                                        senid: snid[snid.length - 1],
                                        intvl: 10
                                    }
                                }).then(function querySuccess(response) {
                                    mapService_dashboard.sensorDetail(feature, lyrnm, response.data);
                                }, function queryError(response) {
                                    console.log('connection failed');
                                });
                                wclk = 1;
                    ...
                    if (wclk == 0) {
                        ...
                        mapService_dashboard.sensorDetail(undefined, undefined);
                        mapService_dashboard.hs_clicked = undefined;
                        mapService_dashboard.sens_clicked = undefined;
                        mapService_dashboard.type_clicked = undefined;
                        mapService_dashboard.senstype_clicked = undefined;
                    }
                });
                $('#map_dashboard').data('map_dashboard', map_dashboard);
                mapService_dashboard.mapInit(map_dashboard, view);
            }
        };
    }]);