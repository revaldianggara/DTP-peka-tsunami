<?php
    ...
    $query = "SELECT output_tsunami.tid AS id, output_tsunami.eta AS eta, tsunami_simulasi.nama_area AS area,
            ...
            WHERE output_tsunami.eq_id=$1 AND model_id = $2 AND output_tsunami.ketinggian>0.3 ORDER BY output_tsunami.eta ASC;";
